...
const validCountryCodes = [
    "91", "65", "1", "20", "27", "30", "31", "32", "33", "34", "36", "39", "40", "41", "43", "44", "45", "46", "47", "48", "49",
    "51", "52", "53", "54", "55", "56", "57", "58", "60", "61", "62", "63", "64", "66", "81", "82", "84", "86", "90",
    "92", "93", "94", "95", "98", "211", "212", "213", "216", "218", "220", "221", "222", "223", "224", "225", "226", 
    ...
    "670", "671", "672", "673", "674", "675", "676", "677", "678", "679", "680", "681", "682", "683", "685", "686", 
...
class Client extends EventEmitter {
    ...
    */
    ...
    async getCountryCode(number) {
        ...
        return await this.pupPage.evaluate(async numberId => {
            ...
            for (let length = 1; length <= 3; length++) {
                const code = numberId.substring(0, length);
     ...
     * @returns {Promise<string>}
     */
    async extractCountryCode(phoneNumber) {
        for (let length = 1; length <= 3; length++) {
